...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n\nconst URL = \"http://localhost:3000\";\n\nconst addCard = title => axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${URL}/board`, {\n  title: title\n});\n\nconst deleteCard = id => axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete(`${URL}/board/${id}`);\n\nconst getCardsData = () => axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(`${URL}/boards`).then(res => {\n  console.log(res.data);\n  return res.data;\n});\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  addCard,\n  getCardsData,\n  deleteCard\n});\n\n//# sourceURL=webpack:///./client/api.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/style.css */ \"./client/styles/style.css\");\n/* harmony import */ var _styles_style_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_styles_style_css__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _dom_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom.js */ \"./client/dom.js\");\n/* harmony import */ var _api_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./api.js */ \"./client/api.js\");\n\n\n\nconst cardsContainer = document.getElementById(\"cards-container\");\nconst addBtn = document.getElementById(\"add-card-btn\");\naddBtn.addEventListener(\"click\", () => {\n  const _cardTitle = prompt(\"Input card title\");\n\n  if (_cardTitle) {\n    _api_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].addCard(_cardTitle).then(res => {\n      const _cardId = res.data.id;\n      console.log(`id: ${_cardId} title: ${_cardTitle}`);\n      _dom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].renderCard(cardsContainer, {\n        id: _cardId,\n        title: _cardTitle\n      });\n    });\n  }\n});\n_api_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getCardsData().then(data => _dom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].renderAll(cardsContainer, data));\n\n//# sourceURL=webpack:///./client/index.js?");
...
eval("\nvar content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!./style.css */ \"./node_modules/css-loader/dist/cjs.js!./client/styles/style.css\");\n\nif(typeof content === 'string') content = [[module.i, content, '']];\n\nvar transform;\nvar insertInto;\n\n\n\nvar options = {\"hmr\":true}\n\noptions.transform = transform\noptions.insertInto = undefined;\n\nvar update = __webpack_require__(/*! ../../node_modules/style-loader/lib/addStyles.js */ \"./node_modules/style-loader/lib/addStyles.js\")(content, options);\n\nif(content.locals) module.exports = content.locals;\n\nif(false) {}\n\n//# sourceURL=webpack:///./client/styles/style.css?");
